...
public class EmployeeControllerTests {
    ...
    public void givenEmployeeObject_whenGetAllEmployees_thenReturnGetAllEmployeeObject() throws Exception {
        ...
        employeeList.add(Employee.builder().id(1L).firstName("okaner").lastName("tasin").email("okan@gmail.com").build());
        employeeList.add(Employee.builder().id(2L).firstName("ozaner").lastName("tasin").email("ozan@gmail.com").build());
    ...
    public void givenEmployeeId_whenGetEmployeeId_thenReturnEmployeeObject() throws Exception {
        //given-precondition or setup
        long employeeId = 1L;
        Employee employee = Employee.builder().firstName("okan").lastName("tasin").email("okan@gmail.com").build();
